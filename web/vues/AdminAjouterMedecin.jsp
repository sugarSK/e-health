<%-- 
    Document   : AdminAjouterMedecin
    Created on : 24 déc. 2015, 18:09:46
    Author     : soukaina
--%>
    ...
    <![endif]-->
     ...
     <body>
       ...
       <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="col-lg-12">
               <h3 class="page-header" class="box-title"><FONT  size="5pt"><strong>Charger ficher medecin</strong></FONT> </h3>
  
             <form method="post" action="doUploadMedecin" enctype="multipart/form-data">
            <table border="0">
