<%-- 
    Document   : AdminAjouterSecretaire
    Created on : 24 déc. 2015, 18:12:38
    Author     : soukaina
--%>
...
<html>
  ...
  <form method="post" action="doUploadSecretaire" enctype="multipart/form-data">
            <table border="0">
                              <div class="form-group">
                               ...
                               <tr>
                                    <td><input class="form-control" type="text" name="nameFile"  /></td>
                               </tr>
                               <tr>
