               ...
               <h3 class="page-header" class="box-title"><FONT  size="5pt"><strong>Administration</strong></FONT> </h3>
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-8 text-center">
                            <div class="panel-body">
                                    <form  action="modifierSec" role="form" method="post">
                                        <fieldset>
                                                <div class="form-group">
                                                    <label for="disabledSelect">Numero</label>
                                                    <input class="form-control"  type="text" name="id_utilisateur" value="${sec.id_utilisateur}">
                                                </div>                     
                                                <div class="form-group">
                                                    <label>Nom</label>
                                                    <input class="form-control" name="nom" type="text" value="${sec.nom}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Prenom</label>
                                                    <input class="form-control" name="prenom" type="text" value="${sec.prenom}">
                                                </div>
                                                  <div class="form-group">
                                                    <label>Date naissance</label>
                                                    <input class="form-control" name="date_naissance" type="text" value="${sec.date_naissance}">
                                                </div>                                          
                                                <div class="form-group">
                                                    <label>Adresse</label>
                                                    <input class="form-control" name="adresse" type="text" value="${sec.adresse}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Numero telephone</label>
                                                    <input class="form-control" name="numero_telephone" type="text" value="${sec.numero_telephone}">
                                                </div>
                                                 <div class="form-group">
                                                    <label>Numero Medecin</label>
                                                    <input class="form-control" name="id_utilisateur_medecin" type="text" value="${sec.medecin.id_utilisateur}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Login</label>
                                                    <input class="form-control" name="login" type="text" value="${sec.login}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Password</label>
                                                    <input class="form-control" name="password" type="text" value="${sec.password}">
                                                </div>                      
                                          
                                            <!-- Change this to a button or input when using this as a form -->
                                            <input type="submit"  value="ModifierS" class="btn btn-lg btn-warning"/>
                                        </fieldset>
                                    </form>
